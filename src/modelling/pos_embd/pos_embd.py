...
from typing import Tuple, Optional, Dict, Union, NoReturn
...
class PositionEmbedding(keras.layers.Layer):
    ...
    def __init__(self,
                 ...
                 mode: str = MODE_EXPAND,
                 embeddings_initializer: str = 'uniform',
                 embeddings_regularizer: Optional[str] = None,
                 activity_regularizer: Optional[str] = None,
                 embeddings_constraint: Optional[str] = None,
                 mask_zero: Union[bool, int] = False,
                 **kwargs):
        '''
        Args:
            ...
            mask_zero: The index that represents padding. Only works in `append` mode.
            kwargs:
        '''
    ...
    def call(self, inputs: tensorflow.Tensor, **kwargs):
        if self.mode == self.MODE_EXPAND:
